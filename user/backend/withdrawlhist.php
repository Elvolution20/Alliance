      ...
      $amount= $data['amount'];
            ...
            $depid= $data['withid'];
                            ...
                            echo "<tr> ";
                                            ...
                                            echo '<td>'.$status. '</td>';
                                            echo '<td>'.$earn. '</td>';
                          echo "<td> <form method='POST' action='actions/deletewith.php'><input type='hidden' name='withid' value='$depid'> <button type='submit' name='delete' class='btn' style='background-color:#5b53ae;color:white'><i class='fas fa-trash-alt'></i> Delete</button> </form></td>";
