        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
            <div class="login-brand" style="color:orange;">
             Alliancecoinmining exchange time Deposit Gateway
            </div>
            <div class="card ">
              ...
              <?php
                             ...
                             if($trantype == "btc"){
                              ...
                              to your Alliancecoinmining exchange time Wallet via Bitcoin ,Please copy or scan the wallet address below and make a payment of $". $amount." and send exactly the amount to the generated address.
                          ...
                          <br><br>
                           ...
                           <input type='text' class='form-control-plaintext' value='bc1q78mj2kqelxplcc8jl737gmqyc035tc75rr3edz' id='copybtc' readonly=''>
                           ...
                           <img src='https://chart.googleapis.com/chart?chs=250x250&amp;cht=qr&amp;chl=bc1q78mj2kqelxplcc8jl737gmqyc035tc75rr3edz' alt='image' class='imaged w128 rounded'><br><br>
                          ...
                          <p>Copy your unique wallet address and visit either of these platforms to purchase bitcoin and store in your Alliancecoinmining exchange time wallet</p>
                           ...
                           ";
                                 ...
                                 echo " 
                                 <p class='tf' style='color:black'>Hello ".$uname .", You are about to complete a deposit of $". $amount . "
                                 to your Alliancecoinmining exchange time Wallet via Perfect Money ,Please copy or scan the wallet address below and make a payment of $". $amount." and send exactly the amount to the generated address.
                          ...
                          <p>Copy your unique wallet address and proceed to your Perfect money App or website to fund your Alliancecoinmining exchange time wallet</p>
                           <h5 style='color:orange;'>Platforms</h5>
                           <p> Perfect Money via: <a href='https://www.perfectmoney.com' target'blank'>perfectmoney.com</a> to make payment to the copied Perfect Money address, and comfirm payment from your dashboard.</p>
                              ...
                              ";
                                  ...
                                  echo " 
                                  <p class='tf' style='color:black'>Hello ".$uname .", You are about to complete a deposit of $". $amount . "
                                  to your Alliancecoinmining exchange time Wallet via Ethereum ,Please copy or scan the wallet address below and make a payment of $". $amount."  and send exactly the amount to the generated address.
                              
                               
                              <br><br>
                               <label style='color:orange'><i class='far fa-credit-card'></i>Generated Unique Ethereum address</label>
                               <input type='text' class='form-control-plaintext' value='0x4eFa3FF37f35BCA81d79847FB168FA62dFee7Dfa' id='copybtc' readonly=''>
                               <button type='button' id='clickcopy' onClick='mycopy()' class='btn' style='background-color:green;color:white'><i data-feather='copy'></i>copy</button>
                               <a href='proof.php' class='btn' style='background-color:orange;color:black'><i data-feather='corner-up-left'></i>comfirm payment</a><br><br>
                                ...
                                <h4 style='color:orange;'>Payment Qr code generated</h4>
                           <img src='https://chart.googleapis.com/chart?chs=250x250&amp;cht=qr&amp;chl=0x4eFa3FF37f35BCA81d79847FB168FA62dFee7Dfa' alt='image' class='imaged w128 rounded'><br><br>
                           ...
                           <p> Trust wallet via: <a href='https://www.trustwallet.com' target'blank'>trustwallet.com</a> to make payment to the copied ETH address, and comfirm payment from your dashboard.</p>
                            ...
                            <p> Luno via: <a href='https://www.luno.com' target'blank'>Luno.com</a> to make payment to the copied ETH address, and comfirm payment from your dashboard.</p>
                               ...
                               ";
                                 ...
                                 echo " 
                                 <p class='tf' style='color:black'>Hello ".$uname .",You are about to complete a deposit of $". $amount . "
                                 to your Alliancecoinmining exchange time Wallet via USDT ,Please copy or scan the wallet address below and make a payment of $". $amount.".  Make sure you're sending only ERC20_USDT token to the generated wallet address. If you send any other USDT token, you may not be able to retrieve these funds.
                             
                              
                             <br><br>
                              <label style='color:orange'><i class='far fa-credit-card'></i>Generated Unique Payment Address</label>
                              <input type='text' class='form-control-plaintext' value='TPnw8v1ud1S9HKbK2VcaqaRvpeX4k6u9rr' id='copybtc' readonly=''>
                              <button type='button' id='clickcopy' onClick='mycopy()' class='btn' style='background-color:green;color:white'><i data-feather='copy'></i>copy</button>
                              <a href='proof.php' class='btn' style='background-color:orange;color:white'><i data-feather='corner-up-left'></i>comfirm payment</a>
                                ...
                                <h4 style='color:orange;'>Payment Qr code generated</h4>
                           <img src='https://chart.googleapis.com/chart?chs=250x250&amp;cht=qr&amp;chl=TPnw8v1ud1S9HKbK2VcaqaRvpeX4k6u9rr' alt='image' class='imaged w128 rounded'><br><br>
            ...
            <div class="simple-footer">
              Copyright &copy; Alliancecoinmining exchange time 2022
            </div>
          </div>
        </div>
      </div>
