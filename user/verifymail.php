             ...
             <div class="col-xl-6 col-lg-7 col-sm-12 col-12 fxt-bg-color">
                 <div class="fxt-content">
                     <div class="fxt-header">
                         ...
                         <p>Your registration was sucessful!!</p>
                     ...
                     <div class="fxt-footer">
                         <div class="fxt-transformY-50 fxt-transition-delay-9">
                             <p>Please Verify a mail sent to the email address you used for registration. <a href="#0" class="switcher-text2 inline-text"></a> This enables us verify your email. Check your spam since some device settings may treat mails as spam mail. Thank you!!
                               <br> <a href="login.php" class="switcher-text2 inline-text">Done</a> 
                             </p>
                         </div>
                     </div>
                 </div>
